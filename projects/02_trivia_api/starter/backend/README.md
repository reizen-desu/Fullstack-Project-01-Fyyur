...
- Fetches a dictionary of categories, a list of question objects, success value and the toal number of questions.
- As defined in the pagination, only 10 questions are returned.
